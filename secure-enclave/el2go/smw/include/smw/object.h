 ...
 *  - Common return codes
 */
enum smw_status_code smw_find_object_db(struct smw_object_descriptor *descriptor);
 ...
 *  - Common return codes
 */
enum smw_status_code smw_find_object_db_init(void **ctx, smw_attr_attributes_t attributes,
 ...
 *  - Common return codes
 */
enum smw_status_code smw_find_object_db_next(void *ctx, struct smw_object_descriptor *descriptor);
