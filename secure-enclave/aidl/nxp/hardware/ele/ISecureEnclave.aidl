...
interface ISecureEnclave {
	 ...
	 * @param keyId key identifier of the key which would be used to do the cipher.
	 *
	 * @param iv Initialization vector. The length of the IV could be:
	 *           CCM: Must be 12 bytes.
	 *           GCM: Following NIST SP800-38D, it can be:
	 *                0 when the full IV is internally generated.
	 *                4 when the counter IV generation option is used.
	 *                12 when the IV is entirely generated by the user.
	 *           Refer to the EdgeLock Secure Enclave documentation for more details.
	 *
	 * @param iv_out Output initialization vector. The IV would be copied from ELE if
	 *               using either counter or full IV generated by ELE internally.
	 *               Refer to the EdgeLock Secure Enclave documentation for more details.
	 *
	 * @param flags Bit field indicating the requested operations. See 'CipherOperation'
	 *              for possible values.
	 ...
	 * @param output This is output parameter. This byte array will hold the output data of
	 *               the operation.
	 *               In case of "encrypt" mode, it's ciphertext.
