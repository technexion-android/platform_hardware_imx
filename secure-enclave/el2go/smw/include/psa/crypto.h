 ...
 *	implementation-dependent whether a failure to initialize results in this error code.
 */
psa_status_t psa_hash_resume(psa_hash_operation_t *operation, const uint8_t *hash_state,
 ...
 *	implementation-dependent whether a failure to initialize results in this error code.
 */
psa_status_t psa_hash_suspend(psa_hash_operation_t *operation, uint8_t *hash_state,
                              size_t hash_state_size, size_t *hash_state_length);
...
psa_key_derivation_key_agreement(psa_key_derivation_operation_t *operation,
                                 psa_key_derivation_step_t step, psa_key_id_t private_key,
 ...
 * * PSA_ERROR_DATA_INVALID
 */
psa_status_t psa_key_agreement(psa_key_id_t private_key, const uint8_t *peer_key,
                               size_t peer_key_length, psa_algorithm_t alg,
