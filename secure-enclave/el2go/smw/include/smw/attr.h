...
#define SMW_ATTR_NAME(group, name) \
    ((SMW_ATTR_##group##_##name & SMW_ATTR_##group##_MASK) << SMW_ATTR_##group##_OFFSET)

#define SMW_ATTR_VALUE(group, value) \
    (((smw_attr_algo_t)(value) & (SMW_ATTR_##group##_MASK)) << SMW_ATTR_##group##_OFFSET)
...
#define SMW_ATTR_SET_CLEAR_VALUE(flags, group, value)                      \
    (((flags) & ~(SMW_ATTR_##group##_MASK << SMW_ATTR_##group##_OFFSET)) | \
     (((typeof(flags))(value) & (SMW_ATTR_##group##_MASK)) << SMW_ATTR_##group##_OFFSET))

#define SMW_ATTR_GET_VALUE(flags, group) \
    (((flags) >> SMW_ATTR_##group##_OFFSET) & SMW_ATTR_##group##_MASK)

#define SMW_ATTR_SET_MASK(flags, group, name) ((flags) |= SMW_ATTR_##group##_##name)
...
#define SMW_ATTR_IS_NAME_SHIFTED_SET(flags, group, name)                       \
    ((((flags) >> SMW_ATTR_##group##_OFFSET) & (SMW_ATTR_##group##_##name)) == \
     SMW_ATTR_##group##_##name)
...
#define SMW_ATTR_SET_LENGTH(algo, length)                                              \
    (((algo) & ~(SMW_ATTR_LENGTH_MASK << SMW_ATTR_LENGTH_OFFSET)) |                    \
     (((smw_attr_algo_t)(length) & (SMW_ATTR_LENGTH_MASK) & ~SMW_ATTR_LENGTH_MIN_FLAG) \
...
#define SMW_ATTR_IS_MIN_LENGTH(algo)                                                           \
    ((((algo) >> SMW_ATTR_LENGTH_OFFSET) & SMW_ATTR_LENGTH_MASK & SMW_ATTR_LENGTH_MIN_FLAG) == \
 ...
 */
#define SMW_ATTR_SET_MIN_SALT_LENGTH(algo, length) SMW_ATTR_SET_MIN_LENGTH(algo, length)
 ...
 */
#define SMW_ATTR_SET_MIN_MAC_LENGTH(algo, length) SMW_ATTR_SET_MIN_LENGTH(algo, length)
 ...
 */
#define SMW_ATTR_SET_MIN_TAG_LENGTH(algo, length) SMW_ATTR_SET_MIN_LENGTH(algo, length)
...
#define SMW_ATTR_ALGO_DIGEST(hash) \
    (SMW_ATTR_NAME(CLASS, DIGEST) | SMW_ATTR_NAME(ALGO, HASH) | SMW_ATTR_VALUE(HASH, hash))
...
#define SMW_ATTR_ALGO_SYMMETRIC_ENCRYPTION(algo, mode)                         \
    (SMW_ATTR_NAME(CLASS, SYMMETRIC_ENCRYPTION) | SMW_ATTR_VALUE(ALGO, algo) | \
     SMW_ATTR_VALUE(MODE, mode))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_ENCRYPTION(algo, mode)                         \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_ENCRYPTION) | SMW_ATTR_VALUE(ALGO, algo) | \
     SMW_ATTR_VALUE(MODE, mode))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_DEFAULT(mode, hash)                   \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, DEFAULT) | \
     SMW_ATTR_VALUE(MODE, mode) | SMW_ATTR_VALUE(HASH, hash))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_ECDSA(curve, hash)                  \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, ECDSA) | \
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_EDDSA(curve, hash)                  \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, EDDSA) | \
     SMW_ATTR_VALUE(CURVE, curve) | SMW_ATTR_VALUE(HASH, hash))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_DSA(hash)                         \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, DSA) | \
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_RSA(mode, hash, salt)             \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, RSA) | \
     SMW_ATTR_VALUE(MODE, mode) | SMW_ATTR_VALUE(HASH, hash) | SMW_ATTR_VALUE(SALT, salt))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_TLS_1_2_CLIENT(hash)                  \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, TLS_1_2) | \
     SMW_ATTR_NAME(MODE, TLS_1_2_CLIENT) | SMW_ATTR_VALUE(HASH, hash))
...
#define SMW_ATTR_ALGO_ASYMMETRIC_SIGNATURE_TLS_1_2_SERVER(hash)                  \
    (SMW_ATTR_NAME(CLASS, ASYMMETRIC_SIGNATURE) | SMW_ATTR_NAME(ALGO, TLS_1_2) | \
     SMW_ATTR_NAME(MODE, TLS_1_2_SERVER) | SMW_ATTR_VALUE(HASH, hash))
...
#define SMW_ATTR_ALGO_MAC(algo, mode, mac)                                                 \
    (SMW_ATTR_NAME(CLASS, MAC) | SMW_ATTR_VALUE(ALGO, algo) | SMW_ATTR_VALUE(MODE, mode) | \
     SMW_ATTR_VALUE(MAC, mac))
...
#define SMW_ATTR_ALGO_MAC_HMAC(hash, mac)                                                 \
    (SMW_ATTR_NAME(CLASS, MAC) | SMW_ATTR_NAME(ALGO, HMAC) | SMW_ATTR_VALUE(HASH, hash) | \
     SMW_ATTR_VALUE(MAC, mac))
...
#define SMW_ATTR_ALGO_AEAD(algo, mode, tag)                                                 \
    (SMW_ATTR_NAME(CLASS, AEAD) | SMW_ATTR_VALUE(ALGO, algo) | SMW_ATTR_VALUE(MODE, mode) | \
     SMW_ATTR_VALUE(TAG, tag))
...
#define SMW_ATTR_ALGO_KEY_DERIVATION_HKDF(hash) \
    (SMW_ATTR_NAME(CLASS, KEY_DERIVATION) | SMW_ATTR_NAME(ALGO, HKDF) | SMW_ATTR_VALUE(HASH, hash))
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_ENCRYPT(usage) SMW_ATTR_SET_MASK(usage, USAGE, ENCRYPT)
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_DECRYPT(usage) SMW_ATTR_SET_MASK(usage, USAGE, DECRYPT)
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_SIGN_MESSAGE(usage) SMW_ATTR_SET_MASK(usage, USAGE, SIGN_MESSAGE)
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_VERIFY_MESSAGE(usage) SMW_ATTR_SET_MASK(usage, USAGE, VERIFY_MESSAGE)
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_SIGN_HASH(usage) SMW_ATTR_SET_MASK(usage, USAGE, SIGN_HASH)
 ...
 * A valid usage.
 */
#define SMW_ATTR_USAGE_SET_VERIFY_HASH(usage) SMW_ATTR_SET_MASK(usage, USAGE, VERIFY_HASH)
 ...
 */
#define SMW_ATTR_USAGE_IS_EXPORT(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, EXPORT)
 ...
 */
#define SMW_ATTR_USAGE_IS_ENCRYPT(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, ENCRYPT)
 ...
 */
#define SMW_ATTR_USAGE_IS_DECRYPT(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, DECRYPT)
 ...
 */
#define SMW_ATTR_USAGE_IS_SIGN_MESSAGE(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, SIGN_MESSAGE)
 ...
 */
#define SMW_ATTR_USAGE_IS_VERIFY_MESSAGE(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, VERIFY_MESSAGE)
 ...
 */
#define SMW_ATTR_USAGE_IS_SIGN_HASH(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, SIGN_HASH)
 ...
 */
#define SMW_ATTR_USAGE_IS_VERIFY_HASH(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, VERIFY_HASH)
 ...
 */
#define SMW_ATTR_USAGE_IS_DERIVE(usage) SMW_ATTR_IS_MASK_SET(usage, USAGE, DERIVE)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_TRANSIENT(attr) SMW_ATTR_SET_CLEAR_NAME(attr, PERSISTENCE, TRANSIENT)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_PERSISTENT(attr) SMW_ATTR_SET_CLEAR_NAME(attr, PERSISTENCE, PERSISTENT)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_PERMANENT(attr) SMW_ATTR_SET_CLEAR_NAME(attr, PERSISTENCE, PERMANENT)
 ...
 */
#define SMW_ATTR_IS_TRANSIENT(attr) SMW_ATTR_IS_NAME_SET(attr, PERSISTENCE, TRANSIENT)
 ...
 */
#define SMW_ATTR_IS_PERSISTENT(attr) SMW_ATTR_IS_NAME_SET(attr, PERSISTENCE, PERSISTENT)
 ...
 */
#define SMW_ATTR_IS_PERMANENT(attr) SMW_ATTR_IS_NAME_SET(attr, PERSISTENCE, PERMANENT)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_LC_CURRENT(attr) SMW_ATTR_SET_NAME_SHIFTED(attr, LIFECYCLE, CURRENT)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_LC_OPEN(attr) SMW_ATTR_SET_NAME_SHIFTED(attr, LIFECYCLE, OPEN)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_LC_CLOSED(attr) SMW_ATTR_SET_NAME_SHIFTED(attr, LIFECYCLE, CLOSED)
 ...
 */
#define SMW_ATTR_IS_LC_CURRENT(attr) SMW_ATTR_IS_NAME_SHIFTED_SET(attr, LIFECYCLE, CURRENT)
 ...
 */
#define SMW_ATTR_IS_LC_OPEN(attr) SMW_ATTR_IS_NAME_SHIFTED_SET(attr, LIFECYCLE, OPEN)
 ...
 */
#define SMW_ATTR_IS_LC_CLOSED(attr) SMW_ATTR_IS_NAME_SHIFTED_SET(attr, LIFECYCLE, CLOSED)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_READ_ONLY(attr) SMW_ATTR_SET_NAME_SHIFTED(attr, RW_FLAGS, READ_ONLY)
 ...
 * Attributes
 */
#define SMW_ATTR_SET_READ_ONCE(attr) SMW_ATTR_SET_NAME_SHIFTED(attr, RW_FLAGS, READ_ONCE)
 ...
 */
#define SMW_ATTR_IS_READ_ONLY(attr) SMW_ATTR_IS_NAME_SHIFTED_SET(attr, RW_FLAGS, READ_ONLY)
 ...
 */
#define SMW_ATTR_IS_READ_ONCE(attr) SMW_ATTR_IS_NAME_SHIFTED_SET(attr, RW_FLAGS, READ_ONCE)
