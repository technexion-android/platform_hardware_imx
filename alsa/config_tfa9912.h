...
#ifndef NXP_CONFIG_TFA9912_H_
#define NXP_CONFIG_TFA9912_H_
...
static struct route_setting speaker_output_tfa9912[] = {
    {
 ...
 * config*/
static struct audio_card tfa9912_card = {
    .name = "TFA9912",
    .driver_name = "TFA9912",
    .bus_name = "I2S2",
    ...
    .defaults = NULL,
    .bt_output = NULL,
    .speaker_output = speaker_output_tfa9912,
    .hs_output = NULL,
